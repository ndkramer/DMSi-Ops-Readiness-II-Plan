...
- See **`Jira/README.md`** for field shapes and import JSON (`../Output/PA-WSB-Jira-Import.json`).
...
| **`Output/`** | Target-state Jira import JSON (`PA-WSB-Jira-Import.json`) and **`Output/Archive/`** snapshots. |
