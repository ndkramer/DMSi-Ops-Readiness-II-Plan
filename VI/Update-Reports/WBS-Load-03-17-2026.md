...
- **WBS archived:** `VI/Archive/VI-WBS-03-17-2026.md`
- **Jira import JSON archived:** `VI/Output/Archive/VI-WBS-Jira-Import-03-17-2026.json`
...
- **Regenerate Jira import JSON** from the updated WBS (manual step until a generator exists). Update `VI/Output/VI-WBS-Jira-Import.json` so it reflects current work_items and action_items keyed by WBS IDs; this file is used by the future Jira upload process.
