...
- **WBS load snapshot archived:** `WSB-WSC/WB/Output/Archive/WB-WBS-Load-Snapshot-03-26-2026.json`
...
- **Regenerate the WBS load snapshot** from the updated WBS (manual step until a generator exists). Update `WSB-WSC/WB/Output/WB-WBS-Load-Snapshot.json` so it reflects current work_items and action_items keyed by WBS IDs; this file is also the bridge for optional Jira upload workflows.
